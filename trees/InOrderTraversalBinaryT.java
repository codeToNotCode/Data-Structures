...
public class InOrderTraversalBinaryT 
{
	/*
	...
	/*
	 * Function to carry out inOrder Traversal of the binary tree using recursion
	 * First all the elements on the left side of the root node are displayed
	 * Second, the root node is displayed
	...
	{
		InOrderTraversalBinaryT bt = new InOrderTraversalBinaryT();
		Node root = bt.createBinaryTree();
		
		System.out.println("Contents of the binary tree in In-Order Traversal :\n");
